  ...
  return (
    <div className="bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 py-16 px-8">
      <div className="container mx-auto text-center text-white">
        ...
        <div className="flex flex-col items-center bg-white rounded-lg shadow-lg p-6 m-6 transform hover:scale-105 transition duration-300 ease-in-out text-gray-800">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 px-4">
          <div className="flex flex-col items-center rounded-lg shadow-lg p-6 transform hover:scale-105 transition duration-300 ease-in-out bg-white">
          ...
          <div className="flex flex-col items-center bg-white rounded-lg shadow-lg p-6 transform hover:scale-105 transition duration-300 ease-in-out">
        ...
        <div className="flex flex-col items-center bg-white rounded-lg shadow-lg p-6 m-6 transform hover:scale-105 transition duration-300 ease-in-out">
          <div className="mt-16">
