...
import { FaHome, FaPlus, FaUserAlt, FaSignOutAlt, FaGoogle, FaHandshake, FaSignInAlt, FaInfoCircle, FaEnvelope } from "react-icons/fa";

function Header({ role }) {

  return (
    <header className="bg-gray-100 text-gray-800 py-4 shadow-xl sticky top-0 z-50 ">
      <div className="max-w-7xl mx-auto flex justify-between items-center px-6">
        ...
        {(role === "USER" || role === "Guest") && (
          <nav className="hidden md:flex gap-2 text-sm flex-grow justify-center">
            {[
              ...
              <Link
                key={to}
                to={to}
                className="flex items-center gap-1 px-3 py-2 text-sm rounded-lg bg-gray-100 hover:bg-gray-200 transition-all"
              >
